...
class TextPreprocessing:
    def __init__(self):
        ...
        self.additional_stopwords = ['cm', 'kg', 'gr', 'gram', 'ml', 'liter', 'blok', 'biji', 'pcs', 'ikat', 'jempol', 'ekor', 'siung', 'sejumput', 'batang', 'buah', 'potong', 'butir', 'bonggol', 'balok', 'genggam', 'lembar', 'papan', 'sdt', 'sdm', 'paha', 'dada', 'filet', 'fillet', 'iris']
